...
namespace XPostProcessing
{
    ...
    [Serializable]
    [PostProcess(typeof(EdgeDetectionScharrNeonRenderer), PostProcessEvent.AfterStack, "X-PostProcessing/EdgeDetection/EdgeDetectionScharrNeon")]
    public class EdgeDetectionScharrNeon : PostProcessEffectSettings
    {
        [Range(0.05f, 5.0f)]
    ...
    public sealed class EdgeDetectionScharrNeonRenderer : PostProcessEffectRenderer<EdgeDetectionScharrNeon>
    {

        private const string PROFILER_TAG = "X-EdgeDetectionScharrNeon";
        private Shader shader;


        public override void Init()
        {
            shader = Shader.Find("Hidden/X-PostProcessing/EdgeDetectionScharrNeon");
        }
