...
namespace XPostProcessing
{
    ...
    [Serializable]
    [PostProcess(typeof(EdgeDetectionScharrNeonV2Renderer), PostProcessEvent.AfterStack, "X-PostProcessing/EdgeDetection/EdgeDetectionScharrNeonV2")]
    public class EdgeDetectionScharrNeonV2 : PostProcessEffectSettings
    {
        [Range(0.05f, 5.0f)]
    ...
    public sealed class EdgeDetectionScharrNeonV2Renderer : PostProcessEffectRenderer<EdgeDetectionScharrNeonV2>
    {

        private const string PROFILER_TAG = "X-EdgeDetectionScharrNeonV2";
        private Shader shader;


        public override void Init()
        {
            shader = Shader.Find("Hidden/X-PostProcessing/EdgeDetectionScharrNeonV2");
        }
