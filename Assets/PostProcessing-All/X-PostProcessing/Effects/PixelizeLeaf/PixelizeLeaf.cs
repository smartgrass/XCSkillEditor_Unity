...
namespace XPostProcessing
{
    ...
    [Serializable]
    [PostProcess(typeof(PixelizeLeafRenderer), PostProcessEvent.BeforeStack, "X-PostProcessing/Pixelize/PixelizeLeaf")]
    public class PixelizeLeaf : PostProcessEffectSettings
    {
    ...
    public sealed class PixelizeLeafRenderer : PostProcessEffectRenderer<PixelizeLeaf>
    {
        private const string PROFILER_TAG = "X-PixelizeLeaf";
        private Shader shader;

        public override void Init()
        {
            shader = Shader.Find("Hidden/X-PostProcessing/PixelizeLeaf");
        }
