...
namespace XPostProcessing
{
    ...
    [Serializable]
    [PostProcess(typeof(EdgeDetectionScharrRenderer), PostProcessEvent.AfterStack, "X-PostProcessing/EdgeDetection/EdgeDetectionScharr")]
    public class EdgeDetectionScharr : PostProcessEffectSettings
    {
    ...
    public sealed class EdgeDetectionScharrRenderer : PostProcessEffectRenderer<EdgeDetectionScharr>
    {

        private const string PROFILER_TAG = "X-EdgeDetectionScharr";
        private Shader shader;


        public override void Init()
        {
            shader = Shader.Find("Hidden/X-PostProcessing/EdgeDetectionScharr");
        }
