...
namespace XPostProcessing
{
    ...
    [Serializable]
    [PostProcess(typeof(EdgeDetectionRobertsNeonV2Renderer), PostProcessEvent.AfterStack, "X-PostProcessing/EdgeDetection/EdgeDetectionRobertsNeonV2")]
    public class EdgeDetectionRobertsNeonV2 : PostProcessEffectSettings
    {
        [Range(0.05f, 5.0f)]
    ...
    public sealed class EdgeDetectionRobertsNeonV2Renderer : PostProcessEffectRenderer<EdgeDetectionRobertsNeonV2>
    {

        private const string PROFILER_TAG = "X-EdgeDetectionRobertsNeonV2";
        private Shader shader;


        public override void Init()
        {
            shader = Shader.Find("Hidden/X-PostProcessing/EdgeDetectionRobertsNeonV2");
        }
