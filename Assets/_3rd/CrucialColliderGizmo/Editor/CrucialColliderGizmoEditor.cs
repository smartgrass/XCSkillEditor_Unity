...
public class CrucialColliderGizmoEditor : Editor
{
	...
	public override void OnInspectorGUI()
	{
		...
		target.edgePointMarkerRadius = EditorGUILayout.FloatField(new GUIContent("Edge Collider Marker Radius", "The radius of the collider marker on your collider(s)."), target.edgePointMarkerRadius);
		...
		target.collider2D_ZDepth = EditorGUILayout.FloatField(new GUIContent("BoxCollider2D Z Depth", "The thickness, or Z axis length, of your 2D box collider visualizations. This is just to help assist in 3D visualization of 2D colliders, as the visual thickness of this representation will not reflect any change in the collider's behavior at runtime."), target.collider2D_ZDepth);
