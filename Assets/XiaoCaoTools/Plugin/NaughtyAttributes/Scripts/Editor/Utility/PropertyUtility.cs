...
namespace NaughtyAttributes.Editor
{
    public static class PropertyUtility
    {
        ...
        //static bool CheckHideList(Object target, FieldInfo fieldInfo)
        //{
        //    Type fieldType = fieldInfo.FieldType;
        //    if (fieldType.IsGenericType)
        //    {
        //        var defType = fieldType.GetGenericTypeDefinition();
        ...
        //            int count = (int)countProperty.GetValue(target);
        //            Debug.Log($"yns len {count} ");
        ...
        //static bool ChechHideProperty(SerializedProperty property)
        //{
        //    HideListIfEmptyAttribute listCheckShowAttribute = GetAttribute<HideListIfEmptyAttribute>(property);
        //    if (listCheckShowAttribute != null)
        //    {
        //        var targetObject = property.serializedObject.targetObject;

        //        FieldInfo fieldInfo = ReflectionUtility.GetField(GetTargetObjectWithProperty(property), property.name);

        //        bool isHide = CheckHideList(targetObject, fieldInfo);
        //        return isHide;
        //    }
        //    return false;
        //}
        ...
        public static bool IsVisible(SerializedProperty property)
        {
            ...
            if (conditionValues.Count > 0)
            {
                ...
                if (enabled == false && !string.IsNullOrEmpty(showIfAttribute.ShowMsg))
                {
                    EditorGUILayout.LabelField(string.Format("{0} {1}", showIfAttribute.ShowMsg, property.displayName));
                } 
                return enabled;
            }
            else
